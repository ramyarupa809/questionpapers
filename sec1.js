document.addEventListener('DOMContentLoaded',function(){
    ...
    if(sum<20){
    document.querySelector("#sco1").innerHTML= "Your score is : "+sum+" "+". The minimum score to pass is 20 . Better luck next time";
...
button.addEventListener ("click", function() {
   window.location.href="home-page.html"
    ...
    document.getElementById("fai1").innerHTML="your score is : "+ sum +" "+". Congratulations! You have cleared section A and B . You are now eligible for section C";
     var button = document.createElement("button");
button.innerHTML = "Go to home-page";
